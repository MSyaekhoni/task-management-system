    ...
    <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
            ...
            <a href="https://flowbite.com" class="flex items-center justify-between">
                <img src="/img/logo.png" class="mr-3 h-6 hidden sm:block" alt="Task Management Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Task
                    Management</span>
            </a>
        </div>
        <div class="md:w-1/2">
