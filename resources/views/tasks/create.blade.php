                ...
                <div class="relative w-full md:max-w-lg space-y-5">
                    ...
                    <div>
                        ...
                        <x-text-input id="category" name="category" type="text" class="mt-1 block w-full"
                            :value="old('category')" required autocomplete="off" />
                ...
                <div class="relative w-full md:max-w-lg space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative mt-1">
                            ...
                            <input id="due_date" name="due_date" value="{{ old('due_date') }}" datepicker
                                datepicker-format="dd-mm-yyyy" datepicker-autohide datepicker-buttons
